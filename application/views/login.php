...
<div class="loginWrapper">
    ...
    <form action="login" method="POST">
        <div class="loginPic">
            <a href="#" title=""><img src="../../images/stick.png" /> </a>
            <?php echo @$error; ?>
        ...
        <input type="text" name="username" placeholder="enter your username" class="loginEmail" />
        ...
        <div class="logControl">
            ...
            <input type="submit" name="login" value="login" class="buttonM bBlue" />
        </div>
    </form>
    
    <!-- New user form -->
    <form action="login" id="recover">
        <div class="loginPic">
